...
{
    public class Runespoor : IAnimal // трёхголовая змея
    {
        ...
        public Runespoor(String name, double foodPerDay, SuitcaseDepartType DepartType, AnimalCompatibility AnimalComp)
        {
            this.Name = name;
